...
3. 1,064 transit agencies ready to onboard today
...
Right now it's showing 2,939 uncovered agencies, of which 1,064 are marked Ready — clean, recently updated feeds, several with realtime data already available. The top of the list is dominated by large, well-known US transit authorities (MBTA, SEPTA, RTD, AC Transit) that are fully absent from Transit's coverage despite mature, high-quality public data.
